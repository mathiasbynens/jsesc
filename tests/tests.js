...
describe('advanced tests', function() {
	...
	it('works correctly for advanced operations', function() {
		...
		const testArray = [
			undefined, { foo: undefined }, Infinity, new Number(Infinity), -Infinity,
		...
		assert.equal(
			...
			'[undefined,{\'foo\':undefined},Infinity,Infinity,-Infinity,-Infinity,0,0,0,0,0,0,function anonymous() {\n\n},\'str\',function zomg() { return \'desu\'; },null,true,true,false,false,{\'foo\':42,\'hah\':[1,2,3,{\'foo\':42}]}]',
